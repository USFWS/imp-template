...
date: "2020"
header-includes:
  - \usepackage{array,titling,caption,pdflscape,booktabs,float,geometry,changepage}
...
###################################################################################################
#  
kable(roc_df[,c(6,5,8,9)], format = "latex", longtable = T,  booktabs = T, escape = FALSE, caption = "\\textbf{Appendix A:} Priority Resources of Concern", col.names = c("Resource of Concern","Rank", "Refuge Purpose", "Rationale")) %>%
...
kable(appndx_B, format = "latex", escape = FALSE, longtable = T,  booktabs = T, caption = "\\textbf{Appendix B:} Nested Resources of Concern (Associated Species)", col.names = c("Resource of\n Concern / Rank", "Nested ROC Species /\n Guild", "Federal\n ESA Status", "Source")) %>%
...
kable(survey_table_appndx, "latex", caption = table2.caption, escape = FALSE, booktabs = T, longtable = T,  col.names = table2.names) %>%
